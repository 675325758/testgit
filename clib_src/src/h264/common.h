...
/* misc math functions */
extern const uint8_t Gw_ff_log2_tab[256];
...
/* math */
int64_t av_const Gw_ff_gcd(int64_t a, int64_t b);
...
{\
    ...
    if(((tcount+tskip_count)&(tcount+tskip_count-1))==0){\
        Gw_av_log(NULL, AV_LOG_ERROR, "%"PRIu64" dezicycles in %s, %d runs, %d skips\n",\
